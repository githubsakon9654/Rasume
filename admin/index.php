...
<nav class="navbar navbar-expand-md bg-warning navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <div  class="container"> <a>ยินดีต้อนรับ Admin</a> <td width="197"><?php echo $objResult["Username"] ?> <a class="nav-link" href="register.php">Admin Register</a><a class="nav-link" href="../user/logout.php">Logout</a> </div> 
  </div>  
</nav>
